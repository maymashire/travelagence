...
-- This script will:
-- 1. Drop existing tables to clear any mismatched schemas (UUID vs BigInt)
-- 2. Re-create tables with consistent BIGINT IDs (matching your frontend mock data)
-- 3. Restore the foreign key relationship needed for the Dashboard
-- 4. Populate the destinations with the correct data
...
CREATE TABLE bookings (
  ...
  destination_id bigint REFERENCES destinations(id), -- This creates the relationship!
  booking_type text,
  total_price numeric,
  travelers integer,
  start_date date,
